...
- Imported parts into `./phaser3-tutorial-src` and running `http-server ./phaser3-tutorial-src` (remember to change name of file to `index.html` from e.g. `partX.html`)
